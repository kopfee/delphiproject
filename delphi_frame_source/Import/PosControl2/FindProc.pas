{***************************************************************************}
{  Date: 26.12.97                                            Time: 17:30:40 }
{  Copyright (c)1996-1997                                                   }
{  © by Dr.Plass                                               TFindProc3.0 }
{                                                                           }
...
const
 cAbout = 'TFindProc3.0: ©1997 by Dr.Peter Plass';
...
begin
 if value <> fAbout then begin
  fAbout := cAbout;
  MessageDlg('Komponente: TFindProc3.0            '+ #10#13+ #10#13+
             '©1997 by Dr.Peter Plass             '+ #10#13+
...
procedure Register;
begin
 RegisterComponents('PosControl2', [TProcList]);
end;
end.
