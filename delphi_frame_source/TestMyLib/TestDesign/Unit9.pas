...
uses
  ...
  Design, StdCtrls, ExtCtrls, Buttons,ComCtrls;
...
type
  TForm1 = class(TForm)
    ...
    procedure cbDesignNewClick(Sender: TObject);
...
procedure TForm1.cbDesignNewClick(Sender: TObject);
begin
  designer1.NotDesignNewCtrl := cbDesignNew.checked;
end;

procedure TForm1.btnRTFClick(Sender: TObject);
begin
  NewCtrl(TRichEdit);
end;
