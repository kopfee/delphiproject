...
// *********************************************************************//
  ...
  private
    ...
    FIntf: IActiveMovie2;
    function  GetControlInterface: IActiveMovie2;
  protected
  ...
  public
    ...
    property  ControlInterface: IActiveMovie2 read GetControlInterface;
...
procedure TActiveMovie.CreateControl;
  ...
  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IActiveMovie2;
  end;
...
function TActiveMovie.GetControlInterface: IActiveMovie2;
begin
  CreateControl;
  Result := FIntf;
end;
