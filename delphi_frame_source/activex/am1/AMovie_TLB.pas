...
// File generated on 99-1-30 10:36:39 from Type Library described below.

// ************************************************************************ //
// Type Lib: D:\HUANGYL\ACTIVEX\AM1\AMOVIE.OCX
...
// Default Interface: IActiveMovie
// Def. Intf. DISP? : No
// Event   Interface: DActiveMovieEvents
...
// *********************************************************************//
  ...
  private
    ...
    FIntf: IActiveMovie;
    function  GetControlInterface: IActiveMovie;
  protected
  ...
  public
    ...
    procedure Pause;
    procedure Stop;
    property  ControlInterface: IActiveMovie read GetControlInterface;
...
procedure TActiveMovie.CreateControl;
  ...
  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IActiveMovie;
  end;
...
function TActiveMovie.GetControlInterface: IActiveMovie;
begin
  CreateControl;
  Result := FIntf;
end;
